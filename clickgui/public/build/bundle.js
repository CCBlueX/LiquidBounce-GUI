...
var app = (function () {
    ...
    function instance_1$4($$self, $$props, $$invalidate) {
    	...
    	function setTogglableValue(e) {
    		...
    		$$invalidate(1, settings = toJavaScriptArray(instance.getContainedValues()));
    	}
    ...
    function create_if_block$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(55:4) {#if settings.length > 0}",
    		ctx
    	});
    ...
    function create_each_block$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(57:12) {#each settings as s}",
    		ctx
    	});
    ...
    function instance_1$2($$self, $$props, $$invalidate) {
    	...
    	function handleToggleExpand() {
    		...
    		if (expanded) {
    			$$invalidate(1, settings = toJavaScriptArray(instance.getActiveChoice().getContainedValues()));
    		}
    	}
    ...
    // (85:8) {#each renderedModules as m}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(85:8) {#each renderedModules as m}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*categories, getModulesOfCategory*/ 12) {
    ...
    // (54:4) {#each categories as category}
    function create_each_block(ctx) {
    	...
    	panel = new Panel({
    			props: {
    				...
    				modules: /*getModulesOfCategory*/ ctx[3](/*category*/ ctx[6])
    			},
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(54:4) {#each categories as category}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*clickGuiOpened*/ ctx[1] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block) if_block.c();
    			if_block_anchor = empty();
    			attr_dev(div, "id", "bg-drag");
    			attr_dev(div, "class", "svelte-r6rs4l");
    			add_location(div, file, 50, 0, 1263);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "mousedown", /*divMouseDown*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (/*clickGuiOpened*/ ctx[1]) if_block.p(ctx, dirty);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(if_block);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("isMousePressed" in $$props) isMousePressed = $$props.isMousePressed;
    		if ("clickGuiOpened" in $$props) $$invalidate(1, clickGuiOpened = $$props.clickGuiOpened);
    	};
    	...
    	return [divMouseDown, clickGuiOpened, categories, getModulesOfCategory];
    }
